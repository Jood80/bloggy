...
import gsap, { timeline, Power0 } from 'gsap'
...
function init() {
  ...
  var tl = timeline({ repeat: -1, repeatDelay: 1.0, yoyo: true });
...
Slide.prototype.transition = function () {
  return gsap.fromTo(this, 3.0, { time: 0.0 }, { time: this.totalDuration, ease: Power0.easeInOut });
};
